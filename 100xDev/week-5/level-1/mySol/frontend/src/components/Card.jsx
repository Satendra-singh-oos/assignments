  ...
  return (
    <div className="w-[300px] border rounded-2xl">
      ...
      <div className="p-4">
        ...
        <button
          type="button"
          className="mt-4 w-full rounded-sm bg-black px-2 py-1.5 text-sm font-semibold text-white shadow-sm hover:bg-black/80 focus-visible:outline-offset-2 focus-visible:outline-black"
        >
          Interested
        </button>
      </div>
